...
namespace {
const char* SSID          = "Narong_2.4G";   // Change this to your WiFi name
const char* PASSWORD      = "29518518";    // Change this to your WiFi password
const char* USERNAME      = "Wirulyapat";     // Change this to your Duino-Coin username
const char* RIG_IDENTIFIER = "ESP01-MCU08";       // Change this if you want a custom miner name
